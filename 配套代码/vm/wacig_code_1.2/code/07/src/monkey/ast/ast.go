...
func (oe *InfixExpression) Literal() string { return oe.Token.Literal }
...
func (al *ArrayLiteral) Literal() string { return al.Token.Literal }
...
func (hl *HashLiteral) Literal() string { return hl.Token.Literal }
